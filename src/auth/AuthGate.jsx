    ...
    <div style={wrap}>
      <div style={{ maxWidth: 460, background: '#FFF', border: '1px solid #E5E7EB', padding: 28 }}>
        ...
        <div style={{ fontSize: 13, color: '#6B7280', lineHeight: 1.6 }}>
          This deployment is missing its API URL. Set VITE_API_URL (your deployed
          Cloudflare Worker URL) in your environment — for local dev, add it to
          .env.local; in production, set it under Cloudflare Pages → Settings →
